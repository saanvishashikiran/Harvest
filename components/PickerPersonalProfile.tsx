        ...
        <ScrollView  contentContainerStyle = {{flexGrow: 1}}>
            ...
            <View style = {styles.image}>
                {profile ? ( <Image source = {{uri : profile}} style = {styles.profileImage} />)
                    : (<Image source = {{uri : "./../photos/Email.png"}} style = {styles.profileImage}/>)
                }
            </View>
            <Text style = {{marginLeft: 170, marginBottom: 5, marginTop: 15}}>5 STARS</Text>
            ...
            <View style = {styles.infoBox}>
                ...
                <TextInput style = {styles.textBox} onChangeText = {bioChange} value = {bio} placeholder = "Biography" />
            </View>
